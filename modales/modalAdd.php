                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipoPersona" id="tipoPersona_natural" value="Natural" checked>
                                    <label class="form-check-label" for="tipoPersona_natural">
                                        Natural
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tipoPersona" id="tipoPersona_juridico" value="Juridico">
