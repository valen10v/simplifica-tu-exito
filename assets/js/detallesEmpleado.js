...
async function cargarDetalleEmpleado(idEmpleado) {
  try {
    ...
    if (response.status === 200) {
      ...
      const { cedula, nombre_completo , correo, usuario, tipo_persona, telefono, avatar } =
        response.data;
      ...
      ulDetalleEmpleado.innerHTML = ` 
        <li class="list-group-item"><b>cedula:</b> 
          ${cedula ? cedula : "No disponible"}
        </li>
        <li class="list-group-item"><b>nombre:</b> 
          ${nombre_completo ? nombre_completo : "No disponible"}
        </li>
        <li class="list-group-item"><b>Correo:</b> 
          ${correo ? correo : "No disponible"}
          </li>
          <li class="list-group-item"><b>usuario:</b> 
          ${usuario ? usuario : "No disponible"}
          </li>
        <li class="list-group-item"><b>Tipo Person:</b>
         ${tipo_persona ? tipo_persona : "No disponible"}
        </li>
